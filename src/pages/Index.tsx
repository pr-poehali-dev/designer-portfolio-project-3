      ...
      <nav className="fixed top-0 w-full z-50 bg-background/80 backdrop-blur-sm border-b border-border">
        <div className="container mx-auto px-6 py-4 flex justify-between items-center">
          <div className="flex items-center space-x-2">
            ...
            <span className="font-serif font-semibold text-xl">Анна Петрова</span>
          </div>
          <div className="hidden md:flex space-x-8">
            <a href="#about" className="hover:text-primary transition-colors">Обо мне</a>
            <a href="#works" className="hover:text-primary transition-colors">Работы</a>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            <p className="text-lg lg:text-xl text-muted-foreground leading-relaxed">
              Я UX/UI дизайнер с опытом работы более 5 лет. Специализируюсь на создании 
              интуитивных и красивых пользовательских интерфейсов для веб и мобильных приложений. 
              Моя цель — сделать цифровые продукты удобными и доступными для всех.
            </p>
            ...
            <div className="grid md:grid-cols-3 gap-8 mt-12">
              ...
              <div className="text-center space-y-4">
                ...
                <h3 className="font-serif text-xl font-semibold">UX Исследования</h3>
                <p className="text-muted-foreground">
              ...
              <div className="text-center space-y-4">
                ...
                <h3 className="font-serif text-xl font-semibold">Мобильный дизайн</h3>
                <p className="text-muted-foreground">
          ...
          <div className="space-y-12">
            <div className="text-center space-y-4">
              ...
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                Ознакомьтесь с некоторыми из моих последних проектов в области UX/UI дизайна
              </p>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-8">
              <Card className="group cursor-pointer border-border hover:border-primary/50 transition-all duration-300">
                ...
                <CardContent className="p-6 space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <Icon name="ExternalLink" size={16} className="text-primary opacity-0 group-hover:opacity-100 transition-opacity" />
                  </div>
                  <p className="text-muted-foreground">
                  ...
                  <div className="flex flex-wrap gap-2">
                    ...
                    <span className="px-3 py-1 bg-primary/10 text-primary text-xs rounded-full">Мобильный дизайн</span>
                    <span className="px-3 py-1 bg-primary/10 text-primary text-xs rounded-full">Прототипирование</span>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="group cursor-pointer border-border hover:border-primary/50 transition-all duration-300">
                ...
                <CardContent className="p-6 space-y-4">
                  ...
                  <div className="flex flex-wrap gap-2">
                    <span className="px-3 py-1 bg-primary/10 text-primary text-xs rounded-full">Веб-дизайн</span>
                    <span className="px-3 py-1 bg-primary/10 text-primary text-xs rounded-full">UX аудит</span>
                    <span className="px-3 py-1 bg-primary/10 text-primary text-xs rounded-full">A/B тестирование</span>
                  </div>
                </CardContent>
              </Card>
            </div>
          ...
          <div className="max-w-4xl mx-auto text-center space-y-12">
            <div className="space-y-4">
              ...
              <p className="text-lg text-muted-foreground">
                Готова обсудить ваш проект и найти лучшие решения для ваших пользователей
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <Card className="border-border hover:border-primary/50 transition-colors">
                <CardContent className="p-6 text-center space-y-4">
                  ...
                  <p className="text-muted-foreground">anna.petrova@email.com</p>
                </CardContent>
              </Card>
      ...
      <footer className="py-12 border-t border-border">
        <div className="container mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="flex items-center space-x-2">
              <div className="w-6 h-6 bg-primary rounded-sm"></div>
              <span className="font-serif font-semibold text-lg">Анна Петрова</span>
            </div>
